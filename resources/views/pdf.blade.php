...
<tr height="10%" style="border-collapse: collapse; background-color: rgba(0, 0, 0, 0.1); border: 1.5px solid black">
    <td colspan="9" >
    <p><img src="{{ $data['image_logo'] ? public_path('storage/'.$data['image_logo']) : "" }}" alt="Logo" style="float: right; background-size: cover; width: 50px; height: 50px; margin-top: 1px;"/></p>
